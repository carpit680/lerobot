...
Teleoperate your arm without a leader arm using Teleop Tongs setup. Follow Teleop Tongs setup documentation [here](https://github.com/carpit680/teleop_tongs/blob/lerobot/README.md).
```bash
python lerobot/scripts/control_robot.py teleoperate \
  --robot-path lerobot/configs/robot/so100.yaml \
  --cam-calib-path lerobot/configs/camera_calibration_results.yaml \
  --urdf-path lerobot/configs/giraffe.urdf \
  --robot-overrides \
    '~cameras'
```
